...
#include "VerdantShiftCharacter.generated.h"
 ...
 */
UCLASS(abstract)
class AVerdantShiftCharacter : public ACharacter
{
	GENERATED_BODY()
...
public:
	...
	/** Uses the same respawn path when the pawn falls below the world's Kill Z. */
